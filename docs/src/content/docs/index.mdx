...
template: splash
hero:
  tagline: Reactive data fetching with effector stores. Powered by TanStack Query — the same battle-tested cache, deduplication, and lifecycle, exposed as effector units.
  actions:
    - text: Get started
